...
- 💡 **Projects include:**
  - **Fine-tuning LLaMA-2 for Product Descriptions:** Implemented supervised fine-tuning of the LLaMA-2-7b-chat model using QLoRA to optimize product description generation for better customer engagement.
  - **ML-Based Solar Capacity Forecasting for Karachi:** Designed and implemented a Random Forest algorithm to forecast solar capacity factors with over 85% accuracy, delivering actionable insights for solar energy utilization.
  - **Bird vs Drone Detection:** Developed a computer vision system using transfer learning with VGG16 to distinguish between birds and drones, achieving 96% accuracy and enhancing aviation safety.
